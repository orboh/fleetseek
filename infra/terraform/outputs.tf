...
output "minecraft_private_ip" {
  description = "Private IP address of the Minecraft server EC2 instance (use this for MINECRAFT_HOST)"
...
output "alb_dns_name" {
  description = "DNS name of the ALB — set NEXT_PUBLIC_API_URL=http://<alb_dns_name>"
